...
<body>
    <div class="container">
        ...
        <div class="navbar">
            ...
            <nav>
                <ul>
<button class="bn"> <a href="index.php"> Acceuil </a></button>
<button class="mn"><a href="#about us"> Contact-us</a></button>
...
<div class="row">
   ...
   </p> <button class="btn"> <a href="formulaire.php">Demander un document</a> </button>
   </div> 
   <div class="col">
