    ...
    <section class="main">
      <section class="Utilisateurs">
          <div class="users-list">
            <h1>Liste des demandes des releves des notes</h1>
            <table class="table">
              <thead>
                <tr>
      <th >#</th>
      ...
      <th>action</th>
          ...
          <tr>
            ...
            <td>
              <div class="icone">
              <a target="_blank" href="print_releve.php?id=<?=$row['apogee']?>" >  <i class="fas fa-check"></i></a>
              <a  href="suppRel.php?id=<?=$row['id']?>"><i class="fas fa-trash"></i></a>
</div>
            </td>
          </tr>
         <?php } ?>
