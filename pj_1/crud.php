...
if($choix = 'attestation'){
  $query1 ="INSERT INTO `archive`(`nom`, `prenom`, `apoge`, `cne`, `email`, `filiere`,`choix` ) 
  VALUES ('$_POST[nom]','$_POST[prenom]','$_POST[apoge]','$_POST[cne]','$_POST[email]','$_POST[filiere]','attestation')";
